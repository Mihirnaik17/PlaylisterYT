...
router.put('/playlist/:id/listen', auth.verify, StoreController.incrementListens)
router.get('/playlists/published', auth.verify, StoreController.getPublishedPlaylists)
